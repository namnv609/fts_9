...
;(function ($, window, document, undefined) {
    ...
    var toggleMenu = function(context, element) {
        ...
        {
            // Close the menu
            self.element.find('.side-nav').stop().slideUp(self.options.speed, function()
            {
        ...
        {
            // Open the menu
            self.element.find('.side-nav').stop().slideDown(self.options.speed, function()
            {
                // Add the open class
    ...
    Plugin.prototype = 
    {
        ...
        init: function(options) {
            ...
            self.element.find('.toggle-sidebar > a').click(function(event)
            {
                // Prevent default action
                event.preventDefault();
